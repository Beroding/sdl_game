...
build:
	gcc src/main.c src/menu_screen.c src/loading_screen.c src/game_screen.c src/player_hud.c src/wandering_enemy.c src/club_notification.c src/collision_system.c src/spawn_animation.c src/battle_system.c src/opening_animation.c src/video_player.c  src/dialogue_loader.c src/pause_menu.c src/save_menu.c src/music_system.c src/sfx_system.c src/save_system.c src/credit_screen.c -o main.exe \
	-I /ucrt64/include \
	-L /ucrt64/lib \
